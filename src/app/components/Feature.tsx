  ...
  return (
    <div>
      <section className='py-8 bg-neutral-50 mb-40'>
        <h2 className='text-center text-3xl font-bold md:text-5xl lg:text-left animate-fade-in--up transiotion-all duration-500 ease-in-out 
        transform hover:translate-y-[-5px] hover:text-black text-red-600'>
          Neha Ghori: Navigating the secret of Technology in Tech Chronicles Blog!

        </h2>

        <p className="text-center m-4 mt-4 text-sm text-black sm:text-base md:mb-12 lg:mb-16 animate-fade-in-up delay-100">
          Join Neha Ghori as the delves into the dynamic world of web development from foundational conceps to advances
          techniques this blog is packed with ingights, tutorials and tips to empower aspiring developers in craftion stunning
          and functional websites,Explore,learn, and elevate your web development journey!
        </p>
